...
#define _INTERVAL_DIST    2 // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO   2 // servo interval (unit: ms)
#define _INTERVAL_SERIAL  5 // serial interval (unit: ms)
...
float volt_to_distance(int a_value)
{
  ...
  return 1138 + (-6.43)*a_value + 0.0128*a_value*a_value + (-8.7E-06)*a_value*a_value*a_value;
}
